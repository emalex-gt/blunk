...
class TenantController extends Controller
{
    ...
    public function create(): Response
    {
        return Inertia::render('SuperAdmin/Tenants/Form', [
            ...
            'settings' => [
                ...
                'manual_price_percentage_mode' => 'cost_markup',
                'manual_price_min_markup_percent' => 0,
                'manual_price_max_discount_percent' => 0,
    ...
    public function edit(Business $business): Response
    {
        ...
        return Inertia::render('SuperAdmin/Tenants/Form', [
            ...
            'settings' => [
                ...
                'manual_price_percentage_mode' => $business->tenantSetting?->manual_price_percentage_mode ?? 'cost_markup',
                'manual_price_min_markup_percent' => $business->tenantSetting?->manual_price_min_markup_percent
                    ?? $business->tenantSetting?->manual_price_min_margin_percent
                    ?? 0,
                'manual_price_max_discount_percent' => $business->tenantSetting?->manual_price_max_discount_percent ?? 0,
    ...
    private function validated(Request $request, ?Business $business = null): array
    {
        $validated = $request->validate([
            ...
            'manual_price_percentage_mode' => ['nullable', Rule::in(['cost_markup', 'price_discount', 'none'])],
            'manual_price_min_markup_percent' => ['nullable', 'numeric', 'min:0', 'max:500'],
            'manual_price_max_discount_percent' => ['nullable', 'numeric', 'min:0', 'max:100'],
        ...
        $payload = [
            ...
            'settings' => [
                ...
                'manual_price_percentage_mode' => $validated['manual_price_percentage_mode'] ?? 'cost_markup',
                'manual_price_min_markup_percent' => round((float) ($validated['manual_price_min_markup_percent'] ?? $validated['manual_price_min_margin_percent'] ?? 0), 2),
                'manual_price_max_discount_percent' => round((float) ($validated['manual_price_max_discount_percent'] ?? 0), 2),
